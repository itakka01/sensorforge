...
)
{
    ...
    // Crop position is defined in DISPLAY coordinates. Rotation 180 uses
    // sensor hmirror+vflip, therefore both raw axes must be inverted so that
    // e.g. "top-left" still means top-left in Live Preview and recordings.
    int rawPositionX =
        positionX;
